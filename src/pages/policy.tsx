...
const Policy: NextPage = () => {
  return (
    <>
      <div className="lg:w-mapXL mx-auto p-14">
        <h1 className="text-2xl lg:text-4xl text-brand-darkest font-semibold pb-12">
          The Clinic Policy
        </h1>

        <h2 className="text-xl text-brand-darkest font-semibold py-2">
          Every Visit
        </h2>
